...
namespace SPDSTools
{
public class SPDSException : Exception
{
    ...
    public SPDSException(string message)
        : base(message)
    {
    }

    public SPDSException(string format, params object[] args)
        : base(String.Format(format, args))
    {
    }

    public SPDSException(Exception ex, string message)
        : base(message)
    {
        _inner = ex;
    }
